    	...
    	<div class="row">
    		...
    		<div class="col-md-6">
    			<div style="text-align: center;" class="login-box">
                    <div style="text-align: center;" id="stat"></div>
    				<br><br><br><br>
    				<h2 style="color: #fff;">Welcome <?= '<span style="color: green;">'.$_SESSION['name'].'</span>'; ?> <br>
    					Please enter the amount to transfer.</h2>
    				<br><br>
                    <input type="hidden" id="account" value="<?= $_SESSION['account']; ?>" name="">
    				<input minlength="10" maxlength="10" style="font-size: 32px; width: 180px; background-color: #404040; color: #fff; text-align: center; " type="text" id="textbox" name="">
                   <br><br>
                   <div id="alpha">
                   ...
                   &nbsp;<a href=""><button class="btn btn-danger" style="font-size: 25px; width: 110px;">Clear</button></a> &nbsp;<button onclick="return sendOtp()" class="btn btn-success" style="font-size: 25px; width: 110px;">Proceed</button>
    			</div>
    		</div>
    		<div class="col-md-2"></div>
    		<div class="col-md-1"></div>
